        ...
        public void Execute(IFileReader reader)
        {
                            ...
                            if (oi.properties is Backdrop bg)
                            {
                                ...
                                while (retry < 5)
                                {
                                    try
                                    {
                                        ...
                                        images[bg.Image].bitmap.SaveToPng($"{objectFolder}{oi.name}.png");
                                        images[bg.Image].bitmap.SaveToPng($"{frameFolder}[UNSORTED]\\{oi.name}.png");
                                        retry = 5;
                                    }
                                    catch
                                    {
                            ...
                            else if (oi.properties is Quickbackdrop qbg)
                            {
                                ...
                                while (retry < 5)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        images[qbg.Image].bitmap.SaveToPng($"{objectFolder}{oi.name}.png");
                                        images[qbg.Image].bitmap.SaveToPng($"{frameFolder}[UNSORTED]\\{oi.name}.png");
                                        retry = 5;
                                    }
                                    catch
                                    {
                                            ...
                                            for (int i = 0; i < frms.Count; i++)
                                            {
                                                ...
                                                while (retry < 5)
                                                {
                                                    ...
                                                    try
                                                    {
                                                        ...
                                                        images[frm].bitmap.SaveToPng($"{directionFolder}_{i}.png");
                                                        images[frm].bitmap.SaveToPng($"{frameFolder}[UNSORTED]\\{oi.name}_{anim.Key}-{dir.Key}_{i}.png");
                                                        retry = 5;
                                                    }
                                                    catch
                                                    {
                                        ...
                                        foreach (var cntrFrm in counter.Frames)
                                        {
                                            ...
                                            while (retry < 5)
                                            {
                                                try
                                                {
                                                    ...
                                                    bmp.SaveToPng($"{objectFolder}{cntrFrm}.png");
                                                    bmp.SaveToPng($"{frameFolder}[UNSORTED]\\{oi.name}_{cntrFrm}.png");
                                                    retry = 5;
                                                }
                                                catch
                                                {
            ...
            try
            {
                ...
                foreach (var img in images)
                {
                    ...
                    img.Value.bitmap.SaveToPng($"{lafFolder}{savedvar}.png");
